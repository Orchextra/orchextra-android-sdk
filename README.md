...
```java
   ...
   compile('com.github.orchextra.orchextra-android-sdk:orchextrasdk:2.4.4:play7Release@aar')
   {transitive true}
...
or with GCM 8.4
```java
   compile('com.github.orchextra.orchextra-android-sdk:orchextrasdk:2.4.4:play8Release@aar')
   {transitive true}
...
or with GCM 9.0
```java
   compile('com.github.orchextra.orchextra-android-sdk:orchextrasdk:2.4.4:play9Release@aar')
     {transitive true}
