...
public abstract class BasicAction {
  ...
  public void createFakeNotification() {
    ...
    fakeNotification.setTitle("");
    fakeNotification.setBody("");
    fakeNotification.setShown(false);
    fakeNotification.setFake(true);
  ...
  public boolean getisFakeNotification() {
    ...
    if (getHasNotification()) {
      if (this.getNotificationBehavior() != null && this.getNotificationBehavior().isFake()) {
        return true;
      }
      return false;
    }
