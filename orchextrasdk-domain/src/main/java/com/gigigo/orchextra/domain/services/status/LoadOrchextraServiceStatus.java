...
public class LoadOrchextraServiceStatus implements DomaninService {

  private final OrchextraStatusDataProvider orchextraStatusDataProvider;

  public LoadOrchextraServiceStatus(OrchextraStatusDataProvider orchextraStatusDataProvider) {
