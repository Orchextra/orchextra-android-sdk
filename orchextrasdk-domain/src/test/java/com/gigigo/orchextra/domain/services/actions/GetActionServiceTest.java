...
public class GetActionServiceTest {
    ...
    public void setUp() throws Exception {
        getActionService = new GetActionService(mockActionsDataProvider, mocKServiceErrorChecker);
    }

    @Test
    public void shouldReturnEmptyListWhenTriggerListIsEmpty() throws Exception {
        InteractorResponse<List<BasicAction>> actionList = getActionService.getActions(new ArrayList<Trigger>());
    ...
    public void shouldReturnEmptyListWhenTriggerListDoesntCorrespondsWithAction() throws Exception {
        ...
        InteractorResponse<List<BasicAction>> actionList = getActionService.getActions(triggerList);
