...
class GetOxToken(threadExecutor: ThreadExecutor, postExecutionThread: PostExecutionThread,
    private val networkDataSource: NetworkDataSource) : Interactor<String>(threadExecutor,
    postExecutionThread) {

  private lateinit var credentials: Credentials

  fun get(credentials: Credentials, onSuccess: (String) -> Unit = onSuccessStub,
  ...
  override fun run() = try {
    notifySuccess(networkDataSource.getAuthentication(credentials))
