...
class UnbindCrm(threadExecutor: ThreadExecutor, postExecutionThread: PostExecutionThread,
    private val networkDataSource: NetworkDataSource,
    private val dbDataSource: DbDataSource) : Interactor<Unit>(threadExecutor,
    postExecutionThread) {

  fun upbind(onSuccess: (Unit) -> Unit = onSuccessStub,
  ...
  override fun run() = try {
    ...
    networkDataSource.unbindCrm()
    dbDataSource.saveCrm(EMPTY_CRM)
    notifySuccess(Unit)
