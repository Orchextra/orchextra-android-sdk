...
import com.gigigo.orchextra.core.domain.entities.DEFAULT_REQUEST_WAIT_TIME
...
fun OkResponse.parseError(): ApiError = with(this) {
    ...
    val body = body?.string() ?: return ApiError(-1, "")
    val response = errorJsonAdapter.fromJson(body)
...
fun ApiConfiguration.toConfiguration(): Configuration = with(this) {
    ...
    return Configuration(
        ...
        requestWaitTime = requestWaitTime ?: DEFAULT_REQUEST_WAIT_TIME,
