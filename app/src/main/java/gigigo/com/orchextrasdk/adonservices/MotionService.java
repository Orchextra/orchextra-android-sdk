...
public class MotionService extends Service implements SensorEventListener {
  ...
  private void sendLocalNotification(boolean isMove, boolean needStopService) {
    ...
    if (!needStopService) {
      ...
      smallIcon =
          isMove ? R.drawable.ic_heart_grey600_24dp : R.drawable.ic_heart_outline_grey600_24dp;
    } else {
    ...
    if (systemService != null) systemService.notify(id_notification, builder.build());
  }
  //endregion
}
