...
public class ActionsSchedulerGcmImpl implements ActionsScheduler {
  ...
  private final Object gcmNetworkManager;
  ...
  public ActionsSchedulerGcmImpl(Context context, Gson gson,
    ...
    this.gcmNetworkManager = null;//GcmNetworkManager.getInstance(context);
...
//    logShowTime(action);
    ...
    orchextraLogger.log("Scheduled action NOT WORK WITH NO PLAY SERVICES "+ action.getId());
